            ...
            <div>  
               ...
               <ItemTemplate>
                <%#(Container.ItemIndex-1)%5==4?" </ul></div><div><ul>":" " %>
                      <li ><img src="images/list-right-point.gif" /><a  href="Detail.aspx?id=<%#Eval("id") %>"><%#Eval("title") %><%#Convert.ToInt32(Eval("isrecommemd"))==1?"<span style='color:red;font-weight:bold'>[推荐]</span>":" " %></a></li>
               </ItemTemplate>
               </asp:Repeater>
               </ul>        
            </div>  
